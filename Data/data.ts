...
export const services: IService[] = [
  ...
  },
  {
    ...
    about: "a daily problem solver in <b>Edabite</b>  and <b>Leet Code</b> ",
  },
   {
     Icon: AiOutlineAntDesign,
     title: "Databases",
     about:
       "I am comfortable working with <b>Firebase</b> and <b>MongoDB</b>",
   },
   {
     Icon: RiComputerLine,
     title: "FullStack development",
     about:
       "I can build outstanding <b>FullStack</b> websites using <b>Next.js</b>",
   },
];
...
export const projects: IProject[] = [
  { 
    name: "Event Tracker",
    description:
      "This app shows you events around the world and helps you register to attend",
